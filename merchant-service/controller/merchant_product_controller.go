...
func NewMerchantProductController(merchanProductUsecase usecase.MerchantProductUsecaseInterface) MerchantProductControllerInterface {
	return &merchantProductController{merchantProductUsecase: merchanProductUsecase}
}
